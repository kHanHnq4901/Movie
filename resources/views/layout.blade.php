   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="row" id="headwrap">
               ...
               <div class="col-md-4 hidden-xs">
                  ...
                  <style>
                     ...
                     .table-history-payment > thead > tr > td {
                        border: 1px white solid;
                        padding: 5px;
                     }
                     .table-history-payment > tbody > tr > td {
                        border: 1px white solid;
                        padding: 5px;
                     }
                  </style>
                 <div class="btn-group">
                  ...
                  <ul class="dropdown-menu menu02" role="menu">
                      ...
                      <li><a href="{{ route('user.vip.index') }}">Nâng cấp tài khoản</a></li>
                      <li><a href="{{ route('history.register.vip') }}">Lịch sử giao dịch</a></li>
                      <li class="divider"></li>
      ...
      <script>
         @if (Session::has('publisher_id'))
              var linkVip = "{{ route('user.vip.index') }}";
         @else
            var linkVip = "{{route('dang-nhap')}}";
         @endif
         ...
         function showUpdateVipAlert() {
            Swal.fire({
               title: "Thông báo",
               text: "Bạn cần nâng cấp tài khoản vip để xem được phim này.",
               icon: "info",
               confirmButtonText: "Nâng cấp",
               showDenyButton: true,
            }).then((result) => {
               if (result.isConfirmed) {
                  location.href = linkVip;
               }
            });
         }
     </script>
     ...
     <script>
         function bookmarks() {
            ...
            $.ajax({
               ...
               success: function (data) {
                  if (data.code == 200) {
                     $('.halim-bookmark-lists').html(data.html);
                     $('#movieCount').text(data.number_movie)
                     Swal.fire({
                        title: "Thông báo",
                        text: data.message,
                        icon: "info",
