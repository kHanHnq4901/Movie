...
use App\Http\Controllers\PublisherVipController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/nang-cap-tai-khoan', [PublisherVipController::class, 'index'])->name('user.vip.index');
Route::post('/register/vip', [PublisherVipController::class, 'registerVip'])->name('register.vip');
Route::get('vip/vnpay/return', [PublisherVipController::class, 'vnpayReturn'])->name('vnpay.return');

Route::get('lich-su-nang-cap-tai-khoan', [PublisherVipController::class, 'historyRegisterVip'])->name('history.register.vip');

Route::get('payments', [PublisherVipController::class, 'payments'])->name('payments.vip');

Route::delete('payment/destroy/{id}', [PublisherVipController::class, 'paymentDestroy'])->name('payment.destroy');
