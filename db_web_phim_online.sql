...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2023 at 06:12 PM
...
(1, 7, 81, '2023-07-10 22:04:07'),
(3, 7, 63, '2023-07-10 22:12:07');
...
(36, 70, '<iframe width=\"100%\" height=\"100%\" frameborder=\"0\" allowtransparency=\"true\" allowfullscreen=\"true\" scrolling=\"no\" src=\"https://1080.opstream4.com/share/1b4ea86404d0b479c4a73e55dfd8b0b7\"></iframe>', 3, 1),
...
(39, 81, '<iframe width=\"100%\" height=\"100%\" frameborder=\"0\" allowtransparency=\"true\" allowfullscreen=\"true\" scrolling=\"no\" src=\"https://kd.opstream3.com/share/b1562246c02be63bac86a26684cdce58\"></iframe>', 1, 6),
...
(46, 70, '<iframe width=\"100%\" height=\"100%\" frameborder=\"0\" allowtransparency=\"true\" allowfullscreen=\"true\" scrolling=\"no\" src=\"https://1080.opstream4.com/share/1b4ea86404d0b479c4a73e55dfd8b0b7\"></iframe>', 3, 6);
...
(1, 'Link Thường', 'Link có quảng cáo', 0),
...
CREATE TABLE `payments` (
  ...
  `money` bigint(20) DEFAULT NULL COMMENT 'Số tiền thanh toán',
  `vnp_response_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Mã phản hồi',
  `code_vnpay` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Mã giao dịch vnpay',
  `code_bank` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Mã ngân hàng',
  `note` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nội dung thanh toán',
  `time_payment` datetime DEFAULT NULL COMMENT 'Thời gian chuyển khoản',
...
INSERT INTO `payments` (`id`, `publisher_id`, `product_id`, `number_month`, `discount`, `transaction_code`, `money`, `vnp_response_code`, `code_vnpay`, `code_bank`, `note`, `time_payment`, `method`, `status`, `created_at`, `updated_at`) VALUES
(1, 7, 2, 2, NULL, 'FHORDMJzQTZzV5A', 220000, '00', '14061434', 'NCB', 'Thanh toan GD: Tai khoan duocnvoit thuc hien nang cap them 2thang.', '2023-07-09 11:00:00', 'METHOD_VNPAY', 1, NULL, NULL),
(2, 7, 3, 3, NULL, 'McUql9ShFtKBKdX', 350000, '00', '14061443', 'NCB', 'Thanh toan GD: Tai khoan duocnvoit thuc hien nang cap them 3thang.', '2023-07-09 11:27:00', 'METHOD_VNPAY', 1, NULL, NULL),
(4, 9, 1, 1, NULL, 'zfDpSSd1KljCvOT', 150000, '00', '14062851', 'NCB', 'Thanh toan GD: Tai khoan duocnvoit345 thuc hien nang cap them 1thang.', '2023-07-10 23:07:00', 'METHOD_VNPAY', 1, NULL, NULL);
...
INSERT INTO `products` (`id`, `name`, `number_month`, `discount`, `price`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Một Tháng', 1, NULL, 150000, 1, '2023-07-08 21:21:41', '2023-07-08 21:21:41'),
(2, 'Hai Tháng', 2, NULL, 220000, 1, '2023-07-08 21:21:41', '2023-07-08 21:21:41'),
(3, 'Ba tháng', 3, NULL, 350000, 1, '2023-07-08 21:23:50', '2023-07-08 21:23:50'),
(4, 'Năm Tháng', 5, NULL, 450000, 1, '2023-07-08 21:22:49', '2023-07-08 21:22:49');
...
CREATE TABLE `publishers` (
  ...
  `start_vip` date DEFAULT NULL,
  `end_vip` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `publishers` (`id`, `name`, `email`, `phone`, `username`, `password`, `created_at`, `levels_acc`, `start_vip`, `end_vip`) VALUES
(4, 'Trần Quang Thiện', 'tranquangthientqt1@gmail.com', '0392782962', 'tranquangthientqt', '25d55ad283aa400af464c76d713c07ad', '2023-06-26 15:53:02', 0, NULL, NULL),
(5, 'Trần Quang Thiện', 'kubidepzaj2108@gmail.com', '0392782961', 'tranquangthie', 'da71acf0e32b013f72f6fbfdc7d9fdef', '2023-06-28 17:49:06', 0, NULL, NULL),
(6, 'Trần Quang Thiện', 'tranquangthientqt1@g', '0392782942', 'tranquangthient', 'da71acf0e32b013f72f6fbfdc7d9fdef', '2023-06-28 18:46:48', 0, NULL, NULL),
(7, 'duocnvoit', 'duocnvoit@gmail.com', '0928817228', 'duocnvoit', '25d55ad283aa400af464c76d713c07ad', '2023-07-08 17:19:27', 0, '2023-07-01', '2023-12-15'),
(8, 'duocnvoit123', 'duocnvoit123@gmail.com', '0928050899', 'duocnvoit123', '25d55ad283aa400af464c76d713c07ad', '2023-07-09 17:12:46', 0, NULL, NULL),
(9, 'duocnvoit345', 'duocnvoit345gmail.com', '0359020898', 'duocnvoit345', '25d55ad283aa400af464c76d713c07ad', '2023-07-10 23:05:03', 0, '2023-07-10', '2023-08-10');
...
(1, 'Trần Quang Thiện', 'tranquangthientqt1@gmail.com', NULL, '$2y$10$fwZvtE0nXy0Xkl.zXM4xVeePSHZlLA4S/VxRSOdiw03wQqSuj9HKW', 'Fa3T4yJwzHod5qFdElWBSllk7BCAK6S7ZkXlTUV6PWYgI2WomXxG6yQ0oGm6', '2023-05-16 16:42:33', '2023-05-16 16:42:33');
